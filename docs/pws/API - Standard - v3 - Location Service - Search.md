...
| ![][image1] | Location Service \- Search \- v3.0 Domain Portfolio: Utility  |  Domain: Search  |  Usage Classification: Standard Geography: Global Attribution Required: N/A Attribution Requirements:  N/A  |
| :---- | ----- |
...
| Request by City Name: Required Parameters: query, language, format   ||  Optional Parameters: countryCode, adminDistrictCode, locationType, proximity, fuzzyMatch, countryFilter Returns information in an array for the string included in the query= parameter.  The optional parameters further refine the search response.   | Aggregate Product Name |
| :---- | :---- |
| https://api.weather.com/v3/location/search?**query=atlanta**\&language=en-US\&format=json\&apiKey=**yourApiKey**   https://api.weather.com/v3/location/search?**query=Lincoln Memorial Circle SW**&**locationType=address**\&language=en-US\&format=json\&apiKey=**yourApiKey**  | v3-location-search |
...
| fuzzyMatch | Specify whether the database should attempt approximate and/or exact matching to the query string provided in the request.   true \= attempt approximate and exact matching false \= attempt exact matching only Note: requests without this query parameter default the value to ‘true’ | boolean | true or false | true |
| countryFilter | Specify the query string results to exclude the provided country code. | string | Any valid ISO 3166 alpha 2 code. | US |
...
| locationCategory | A sub-type of the 'type' field that describes a more specific grouping for the location record. | \[string\] | Any valid locationCategory | national park | Y |
...
| type | Geospatial definition for the location record. (location type). | \[string\] | Any valid type | city, address | N |
| locale | Object for additional city & sub-city locale information. | \[array\] |  |  |  |
...
| *// Response Collapsed for Presentation Purposes* {   "location": {     "address": \[       "Manhatten, Florida, United States"     \],     "adminDistrict": \[       "Florida"     \],     "adminDistrictCode": \[       "FL"     \],     "city": \[       "Astor"     \],     "country": \[       "United States"     \],     "countryCode": \[       "US"     \],     "dmaCd": \[       "501"     \],     "displayName": \[       "Manhatten"     \],     "displayContext": \[       "Astor, United States"     \],     "ianaTimeZone": \[       "America/New\_York"     \],     "latitude": \[       29.139     \],     "locale": \[       {         "locale1": "Lake County",         "locale2": "Astor",         "locale3": "Manhatten",         "locale4": null       }     \],     "longitude": \[       \-81.516     \],     "neighborhood": \[       null     \],     "placeId": \[       "46a3eae0e75cf5cf212c6362d55459051b62d4a3276a08e00a05e559ba722bb2"     \],     "postalCode": \[       "32102"     \],     "postalKey": \[       "32102:US"     \],     "disputedArea": \[       false     \],     "disputedCountries": \[       null     \],     "disputedCountryCodes": \[       null     \],     "disputedCustomers": \[       null     \],     "disputedShowCountry": \[       \[         false       \]     \],     "iataCode": \[       "SFB"     \],     "icaoCode": \[       "KSFB"     \],     "locId": \[       "USFL0018:1:US"     \],     "locationCategory": \[       null     \],     "pwsId": \[       "KFLASTOR13"     \],     "type": \[       "locality"     \]   } } |
| :---- |
