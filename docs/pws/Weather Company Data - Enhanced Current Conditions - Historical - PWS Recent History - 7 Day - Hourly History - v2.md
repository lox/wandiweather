...
| ![][image1] | Weather Company Data  |  PWS Recent History \- 7 Day \- Hourly History \- v2 Domain Portfolio: Observations  |  Domain: Historical  |  API Name: PWS Recent History \- 7 Day \- Hourly History \- v2 Geography: Global Attribution Required: NO Attribution Requirements:  N/A  |
| :---- | ----- |
...
| Atomic API URL Examples:  | Aggregate Product Name | v2pwsObsHourly7day |
| :---- | ----: | :---: |
...
|  *// Response Collapsed for Presentation Purposes* { observations: \[ { stationID: "KNCCARY89", tz: "America/New\_York", obsTimeUtc: "2019-01-29T05:59:57Z", obsTimeLocal: "2019-01-29 00:59:57", epoch: 1548741597, lat: 35.80221176, lon: \-78.8759613, solarRadiationHigh: 0.0, uvHigh: 0.0, winddirAvg: 135, humidityHigh: 76, humidityLow: 75, humidityAvg: 75, qcStatus: 1, imperial: { tempHigh: 39, tempLow: 39, tempAvg: 39, windspeedHigh: 7, windspeedLow: 0, windspeedAvg: 2, windgustHigh: 7, windgustLow: 3, windgustAvg: 5, dewptHigh: 32.0, dewptLow: 31.0, dewptAvg: 32.0, windchillHigh: 39, windchillLow: 34, windchillAvg: 38, heatindexHigh: 39, heatindexLow: 39, heatindexAvg: 39, pressureMax: 30.01, pressureMin: 29.99, pressureTrend: \-0.02, precipRate: 0.0, precipTotal: 0.0 } } |
| :---- |
